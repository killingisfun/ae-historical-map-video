...
(function () {
    app.beginUndoGroup("Create Russo-Turkish War 1877 V17 Avatar Trails");
    ...
    var FPS = 30;
    var DURATION = 92;
    var comp = app.project.items.addComp("Russo_Turkish_War_1877_V17_Avatar_Trails_92s", W, H, 1, DURATION, FPS);
    ...
    function path(name, points, closed, fill, stroke, width, opacity, parentMap, inverseStrokeEnabled) {
    ...
    tacticalIcon("ico_kishinev_column", new File(tacticalDir.fsName + "/cavalry_blue.png"), 28.32, 47.10, 10.2, 22.0, -42, 44, 20);

    caption(25.0, 38.0, "ЗИМНИЦА -> СВИШТОВ", "27-28 июня 1877: короткая переправа через Дунай показана крупным планом.");
    activeMarker("m_zimnitsa", 25.367, 43.656, "Зимница", COL.blue, 26.0, 51.0, 28, -28);
    activeMarker("m_svishtov", 25.350, 43.620, "Свиштов", COL.blue, 26.0, 67.0, 28, 28);
    ...
    tacticalIcon("ico_crossing_flag", new File(tacticalDir.fsName + "/objective_flag_blue.png"), 25.358, 43.638, 27.4, 39.0, 54, -18, 20);
    ...
    tacticalIcon("ico_nikopol_cannon", new File(tacticalDir.fsName + "/cannon_blue.png"), 25.16, 43.67, 42.0, 52.0, -10, 42, 20);
    ...
    tacticalIcon("ico_gurko_cavalry", new File(tacticalDir.fsName + "/cavalry_blue.png"), 25.47, 42.91, 54.0, 68.0, -48, -42, 21);
    ...
    tacticalIcon("ico_osman_cannon", new File(tacticalDir.fsName + "/cannon_red.png"), 23.48, 43.78, 70.0, 80.0, -46, 42, 21);
    ...
    text("ui_footer_title", "Русско-турецкая война 1877. V17: аватарка ведёт движение, линия остаётся шлейфом.", [58, 970], 23, COL.gold, ParagraphJustification.LEFT_JUSTIFY, false, false);
    text("ui_footer_note", "Ключевые подписи держатся рядом с эпизодом; значки увеличены, а маршруты не спорят с портретами.", [58, 1002], 19, COL.muted, ParagraphJustification.LEFT_JUSTIFY, false, false);
