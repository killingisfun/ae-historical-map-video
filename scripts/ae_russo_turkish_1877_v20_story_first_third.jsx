...
(function () {
    app.beginUndoGroup("Create Russo-Turkish War 1877 V20 Story First Third");
    ...
    var FPS = 30;
    var DURATION = 186;
    var comp = app.project.items.addComp("Russo_Turkish_War_1877_V20_Story_First_Third_186s", W, H, 1, DURATION, FPS);
    ...
    var ROUTE_NEVESINJE_BOSNIA = [[18.11, 43.26], [17.75, 43.38], [17.50, 43.75], [18.42, 43.86]];
    ...
    var ROUTE_INFO_EUROPE = [[23.3, 42.7], [18.4, 48.2], [25.0, 48.2], [29.0, 46.2]];
    var ROUTE_VIENNA_PETERSBURG_UI = [[16.37, 48.21], [22.0, 49.0], [28.0, 47.6]];
    ...
    var ROUTE_SVISHTOV_RUSE = [[25.350, 43.620], [25.70, 43.62], [25.965, 43.835]];
    var ROUTE_SVISHTOV_NIKOPOL = [[25.350, 43.620], [25.16, 43.67], [24.900, 43.700]];
    var ROUTE_SVISHTOV_TARNOVO = [[25.350, 43.620], [25.55, 43.28], [25.636, 43.075]];
    ...
    territoryZone("zone_autonomy_romania", [[22.2, 45.9], [25.8, 45.8], [27.9, 44.5], [27.6, 43.6], [24.9, 43.8], [22.3, 44.1]], COL.blue, COL.cream, 6, 28, 12, true);
    territoryZone("zone_autonomy_serbia", [[19.1, 44.8], [21.1, 44.7], [21.2, 43.2], [19.7, 42.6], [18.8, 43.8]], COL.blue, COL.cream, 6, 28, 12, true);
    territoryZone("zone_autonomy_montenegro", [[18.45, 43.0], [19.25, 42.85], [19.45, 42.30], [18.75, 42.15]], COL.blue, COL.cream, 6, 28, 12, true);
    territoryZone("zone_ottoman_balkans_context", [[18.8, 43.2], [21.6, 43.4], [23.3, 42.9], [27.8, 43.2], [29.0, 41.1], [26.0, 40.7], [21.4, 41.3], [18.4, 42.1]], COL.red, COL.red, 2, 34, 12, false);

    activeMarker("city_sofia_context", 23.321, 42.697, "София", COL.red, 3, 34, 18, 24);
    activeMarker("city_sarajevo_context", 18.414, 43.857, "Сараево", COL.red, 3, 44, 18, -22);

    territoryZone("zone_bosnia_unrest", [[17.2, 44.4], [19.2, 44.3], [19.0, 43.0], [17.4, 42.9]], COL.gold, COL.gold, 34, 64, 22, true);
    activeMarker("m_nevesinje", 18.11, 43.26, "Невесинье", COL.gold, 34, 62, 20, -24);
    routeTrail("r_nevesinje_bosnia", ROUTE_NEVESINJE_BOSNIA, COL.gold, 36, 44, 62);
    tacticalIconOnRoute("ico_nevesinje_unrest", new File(tacticalDir.fsName + "/crossed_swords_gold.png"), ROUTE_NEVESINJE_BOSNIA, 0.45, 35, 62, 0, -44, 22);
    ...
    activeMarker("m_novipazar_1876", 20.515, 43.140, "Нови-Пазар", COL.blue, 49, 66, -102, 20);
    tacticalIconOnRoute("ico_serbian_column", new File(tacticalDir.fsName + "/cavalry_blue.png"), ROUTE_SERBIA_NIS, 0.56, 50, 66, 0, 42, 22);

    territoryZone("zone_bulgarian_april", [[23.7, 42.9], [25.3, 42.8], [25.2, 41.8], [23.6, 41.8]], COL.gold, COL.gold, 76, 106, 24, true);
    activeMarker("m_panagyurishte", 24.183, 42.500, "Панагюриште", COL.gold, 76, 104, 22, -22);
    activeMarker("m_koprivshtitsa", 24.358, 42.633, "Копривштица", COL.gold, 76, 104, 22, -22);
    activeMarker("m_perushtitsa", 24.550, 42.050, "Перуштица", COL.gold, 78, 104, 22, 20);
    activeMarker("m_batak", 24.218, 41.943, "Батак", COL.gold, 78, 104, -66, 22);
    tacticalIcon("ico_april_unrest_1", new File(tacticalDir.fsName + "/crossed_swords_gold.png"), 24.20, 42.42, 77, 92, -32, 24, 20);
    tacticalIcon("ico_april_unrest_2", new File(tacticalDir.fsName + "/camp_gold.png"), 24.45, 42.12, 78, 92, 32, -16, 20);
    pulseRing("pulse_batak_repression", 24.218, 41.943, COL.red, 90, 106, 46);
    pulseRing("pulse_perushtitsa_repression", 24.550, 42.050, COL.red, 90, 106, 42);
    routeTrail("r_info_to_europe", ROUTE_INFO_EUROPE, COL.gold, 93, 101, 112);

    activeMarker("m_constantinople_conf", 28.978, 41.008, "Константинополь", COL.gold, 104, 132, -178, -20);
    territoryZone("zone_reform_bulgaria", [[23.0, 43.2], [26.6, 43.2], [27.2, 41.4], [23.2, 41.4]], COL.gold, COL.gold, 106, 126, 14, true);
    routeTrail("r_diplomacy_to_constantinople", [[16.37, 48.21], [22.0, 45.0], [28.978, 41.008]], COL.gold, 106, 114, 132);
    routeTrail("r_rejected_reforms", [[28.978, 41.008], [26.3, 42.0], [24.4, 42.3]], COL.red, 119, 126, 134);

    territoryZone("zone_bosnia_austro_hint", [[17.1, 44.4], [19.1, 44.3], [18.8, 43.0], [17.4, 43.0]], COL.austro, COL.gold, 132, 154, 20, true);
    routeTrail("r_vienna_russia_deal", ROUTE_VIENNA_PETERSBURG_UI, COL.gold, 132, 140, 154);
    ...
    territoryZone("zone_svishtov_bridgehead_v20", [[25.28, 43.67], [25.44, 43.67], [25.49, 43.59], [25.32, 43.56]], COL.blue, COL.blue, 170, 186, 24, false);
    activeMarker("m_zimnitsa_v20", 25.367, 43.656, "Зимница", COL.blue, 170, 186, -108, -34);
    activeMarker("m_svishtov_v20", 25.350, 43.620, "Свиштов", COL.blue, 170, 186, 42, 38);
    geoLabel("river_danube_crossing_v20", 25.355, 43.648, "Дунай", [0.76, 0.92, 1.0], 170, 186, -4, -52, 18);
    routeTrail("r_zimnitsa_svishtov_v20", ROUTE_ZIMNITSA_SVISHTOV, COL.blue, 171, 178, 186);
    movingMedallion("cmd_dragomirov_proxy", new File(portraitDir.fsName + "/nikolai_nikolaevich_medallion.png"), ROUTE_ZIMNITSA_SVISHTOV, "переправа", "передовые части", 171, 178, 186, "friendly");
    tacticalIconOnRoute("ico_crossing_flag_v20", new File(tacticalDir.fsName + "/objective_flag_blue.png"), ROUTE_ZIMNITSA_SVISHTOV, 0.50, 171, 186, 48, -20, 22);
