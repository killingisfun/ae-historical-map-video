...
def draw_scene(name, title, body, focus_route, scale_name, route_color, portraits, icons, active_route=None, labels=None, callouts=None):
...
def main():
    draw_scene(
        ...
        [("cavalry_blue.png", 28.32, 47.10, -42, 44)],
        ROUTES["kishinev"],
    )
    draw_scene(
        ...
        [("objective_flag_blue.png", 25.358, 43.638, 54, -18)],
        ROUTES["crossing"],
    ...
    draw_scene(
        ...
        [("fort_gold.png", 24.900, 43.700, 50, -44), ("cannon_blue.png", 25.16, 43.67, -10, 42)],
        ROUTES["nikopol"],
    ...
    draw_scene(
        ...
        [("cavalry_blue.png", 25.47, 42.91, -48, -42), ("hill_fort_gold.png", 25.32, 42.75, 46, 18)],
        ROUTES["shipka"],
    )
    draw_scene(
        "05_vidin_plevna",
        ...
        [("cannon_red.png", 23.48, 43.78, -46, 42)],
        ROUTES["plevna"],
    )
    draw_scene(
        "06_plevna_siege",
