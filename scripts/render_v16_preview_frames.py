...
def main():
    draw_scene(
        ...
        "CLOSE",
        COL["blue"],
        [("nikolai_nikolaevich", 28.32, 47.10, 54, -58)],
        [("cavalry_blue.png", 28.32, 47.10, -34, 36)],
        ROUTES["kishinev"],
    )
    draw_scene(
        ...
        "MACRO",
        COL["blue"],
        [("carol_i", 25.362, 43.644, -62, -58)],
        [("objective_flag_blue.png", 25.358, 43.638, 42, -18)],
        ROUTES["crossing"],
    )
    draw_scene(
        "03_shipka_gurko",
        ...
        "CLOSE",
        COL["blue"],
        [("iosif_gurko", 25.50, 43.02, 64, -64)],
        [("cavalry_blue.png", 25.47, 42.91, -42, -34), ("hill_fort_gold.png", 25.32, 42.75, 40, 14)],
        ROUTES["shipka"],
    )
    draw_scene(
        "04_vidin_plevna",
        ...
        "MED",
        COL["red"],
        [("osman_pasha", 23.48, 43.78, 44, -58)],
        [("cannon_red.png", 23.48, 43.78, -38, 34)],
        ROUTES["plevna"],
    )
    draw_scene(
        "05_plevna_siege",
        ...
        [("fort_gold.png", 24.617, 43.417, 0, 48), ("crossed_swords_gold.png", 24.617, 43.417, 0, -42)],
        None,
    )
