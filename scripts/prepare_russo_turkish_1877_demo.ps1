param(
    [string]$OutputDir = "D:\history_video\ae_projects\russo_turkish_1877_v13_action_centered"
)
...
Copy-Item -LiteralPath (Join-Path $scriptsDir "ae_russo_turkish_1877_v13_action_centered.jsx") -Destination (Join-Path $OutputDir "ae_russo_turkish_1877_v13_action_centered.jsx") -Force
...
Write-Host (Join-Path $OutputDir "ae_russo_turkish_1877_v13_action_centered.jsx")
