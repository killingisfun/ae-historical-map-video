param(
    [string]$OutputDir = "D:\history_video\ae_projects\russo_turkish_1877_v14_action_viewport"
)
...
Copy-Item -LiteralPath (Join-Path $scriptsDir "ae_russo_turkish_1877_v14_action_viewport.jsx") -Destination (Join-Path $OutputDir "ae_russo_turkish_1877_v14_action_viewport.jsx") -Force
...
Write-Host (Join-Path $OutputDir "ae_russo_turkish_1877_v14_action_viewport.jsx")
