param(
    [string]$OutputDir = "D:\history_video\ae_projects\russo_turkish_1877_v15_cinematic_commanders"
)
...
Copy-Item -LiteralPath (Join-Path $scriptsDir "ae_russo_turkish_1877_v15_cinematic_commanders.jsx") -Destination (Join-Path $OutputDir "ae_russo_turkish_1877_v15_cinematic_commanders.jsx") -Force
...
Write-Host (Join-Path $OutputDir "ae_russo_turkish_1877_v15_cinematic_commanders.jsx")
