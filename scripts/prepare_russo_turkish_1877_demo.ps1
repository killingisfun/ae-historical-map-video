param(
    [string]$OutputDir = "D:\history_video\ae_projects\russo_turkish_1877_v18_projection_lock"
)
...
Copy-Item -LiteralPath (Join-Path $scriptsDir "ae_russo_turkish_1877_v18_projection_lock.jsx") -Destination (Join-Path $OutputDir "ae_russo_turkish_1877_v18_projection_lock.jsx") -Force
...
Write-Host (Join-Path $OutputDir "ae_russo_turkish_1877_v18_projection_lock.jsx")
