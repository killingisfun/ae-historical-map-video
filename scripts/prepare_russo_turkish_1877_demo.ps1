param(
    [string]$OutputDir = "D:\history_video\ae_projects\russo_turkish_1877_v20_story_first_third"
)
...
Copy-Item -LiteralPath (Join-Path $scriptsDir "ae_russo_turkish_1877_v20_story_first_third.jsx") -Destination (Join-Path $OutputDir "ae_russo_turkish_1877_v20_story_first_third.jsx") -Force
...
Write-Host (Join-Path $OutputDir "ae_russo_turkish_1877_v20_story_first_third.jsx")
