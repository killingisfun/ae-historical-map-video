param(
    [string]$OutputDir = "D:\history_video\ae_projects\russo_turkish_1877_v21_reference_style"
)
...
Copy-Item -LiteralPath (Join-Path $scriptsDir "ae_russo_turkish_1877_v21_reference_style.jsx") -Destination (Join-Path $OutputDir "ae_russo_turkish_1877_v21_reference_style.jsx") -Force
...
Write-Host (Join-Path $OutputDir "ae_russo_turkish_1877_v21_reference_style.jsx")
