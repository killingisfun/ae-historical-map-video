...
(function () {
    app.beginUndoGroup("Create Russo-Turkish War 1877 V18 Projection Lock");
    ...
    var FPS = 30;
    var DURATION = 92;
    var comp = app.project.items.addComp("Russo_Turkish_War_1877_V18_Projection_Lock_92s", W, H, 1, DURATION, FPS);
    ...
    text("ui_footer_title", "Русско-турецкая война 1877. V18: координаты привязаны к реальной PNG-подложке.", [58, 970], 23, COL.gold, ParagraphJustification.LEFT_JUSTIFY, false, false);
    text("ui_footer_note", "Дунай, города, шлейфы и аватарки теперь используют один центрированный map-space.", [58, 1002], 19, COL.muted, ParagraphJustification.LEFT_JUSTIFY, false, false);
