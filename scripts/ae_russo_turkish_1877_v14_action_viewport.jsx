/*
  ...
  - camera staging is derived from the active route/node;
  - action is centered in the clean map viewport, not in the whole comp;
  - tiny and medium movements use stronger zoom so the viewer watches the action.
*/

(function () {
    app.beginUndoGroup("Create Russo-Turkish War 1877 V14 Action Viewport");
    ...
    var FPS = 30;
    var DURATION = 92;
    var comp = app.project.items.addComp("Russo_Turkish_War_1877_V14_Action_Viewport_92s", W, H, 1, DURATION, FPS);
